...
ENV \
		 ...
		 PATH="${APAMA_HOME}/bin:${SAG_HOME}/common/lib/ant/bin:${APAMA_HOME}/third_party/python/bin:${SAG_HOME}/jvm/jvm/jre/bin:${SAG_HOME}/jvm/jvm/bin:$PATH" \
		 PYTHONPATH=${APAMA_HOME}/third_party/python/lib/python3.7/site-packages \
